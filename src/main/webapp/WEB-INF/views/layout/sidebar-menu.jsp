<aside id="s-main-menu" class="sidebar">
	...
	<ul class="smm-alerts">
		<li class="active" data-user-alert="sua-messages"
			data-ma-action="sidebar-open" data-ma-target="user-alerts"><i
			class="zmdi zmdi-email"></i></li>
	...
	<ul class="main-menu">
		...
		<li><a href="widgets.html"><i class="zmdi zmdi-widgets"></i>
				Widgets</a></li>
		<li class="sub-menu"><a href="#" data-ma-action="submenu-toggle"><i
		...
		<li><a href="flot-charts.html"><i
				class="zmdi zmdi-trending-up"></i> Flot Charts</a></li>
		<li class="sub-menu"><a href="#" data-ma-action="submenu-toggle"><i
		...
		<li class="sub-menu"><a href="#" data-ma-action="submenu-toggle"><i
			...
			<ul>
				...
				<li class="sub-menu"><a href="#"
					data-ma-action="submenu-toggle">I have children too</a>
